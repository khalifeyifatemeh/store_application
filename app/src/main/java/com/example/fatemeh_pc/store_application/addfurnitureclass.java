...
public class addfurnitureclass {
    ...
    public addfurnitureclass(){}

    public addfurnitureclass(String fid,String fname,String ftype,String fprice,String fcolor,String ffabric,String fwood,String fcount,String fkosan,String fexist,String fimage){
        this.fid = fid;
        this.fname = fname;
        this.ftype = ftype;
        this.fprice = fprice;
